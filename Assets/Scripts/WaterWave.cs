...
public class WaterWave : MonoBehaviour
{
	...
	[SerializeField][Range(1, 120)] float xSize = 40;
	[SerializeField][Range(1, 120)] float zSize = 40;
	[SerializeField][Range(2, 120)] int xVertexNum = 40;
	[SerializeField][Range(2, 120)] int zVertexNum = 40;
    ...
    void Update()
	{
		...
		for (int z = 0; z < zVertexNum; z++)
		{
			...
			for (int x = 0; x < xVertexNum; x++)
			{
                ...
                //Vector3 offset = GerstnerWave(p, Time.time * waves.rate, waves.length, wave.amplitude, wave.roll);
